...
<v-app id="inspire">
        ...
        <v-list dense id="navigation">
            ...
            <template>
                <v-card>
                    ...
                    <router-link to="/incident" class="v-list-item v-list-item--link theme--light">
                        <div class="v-list__tile__action">
                            <v-icon>mdi-camera-timer</v-icon>
                        </div>
                        <div class="v-list-item__content">
                            <div class="v-list-item__title">Incidents</div>
                        </div>
                    </router-link>
    ...
    <v-app-bar :clipped-left="clipped" app color="red darken-3" dark>
        ...
        <v-toolbar-title style="width: 300px" class="ml-0 pl-4">
            <img src="/logo/logo.png" alt style="width: 90px; height: 46px;">
        </v-toolbar-title>
        <v-spacer />
        <v-spacer />

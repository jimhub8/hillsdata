    ...
    <div class="lg:flex">
        ...
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-12">
                    <form method="POST" action="{{ route('investigator.login') }}" aria-label="{{ __('Login') }}">
                        @csrf
                        <div>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div>
                                    <a class="text-xs font-display font-semibold text-indigo-600 hover:text-indigo-800
                                        cursor-pointer" href="{{ route('investigator.password.request') }}"
                                        style="color: #E3193A;">
                                        Forgot Password?
                                    </a>
                                </div>
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        ...
                        <a class="cursor-pointer text-indigo-600 hover:text-indigo-800" style="color: #E3193A;" href="/client">Client</a>
                    </div>
                </div>
            </div>
        </div>
